    ...
    <div className="bg-white text-gray-800 font-['Fredoka']">
      ...
      <footer className="bg-[#3B1F6A] py-12 text-center border-t border-white/10 font-['Fredoka'] flex flex-col items-center">
        ...
        <div className="flex items-center gap-6 mb-8">
            ...
            <a href="https://t.me/REDBALLOONS" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white hover:scale-110 transition-all" aria-label="Telegram">
                {/* Telegram Icon SVG */}
                <svg viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
